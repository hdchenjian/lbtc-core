...
def update_rpc_node():
    ...
    print(rpc_connection.createrawtransaction([{"txid": "db949bca827cbe1f5f18848cf55cbc2eedd3cf9633fb9b88e546171087cef4ff", "vout": 0}],
                                              {"mtUjv2TWT2wMQ86LoshoK5U8dPTL213Zep": 0.0001}))
    '''
    ...
    #print(rpc_connection.addnode('47.91.209.185:19333', 'add'))
    #print(rpc_connection.addnode('47.91.209.185:19333', 'remove'))
    #print(rpc_connection.addnode('192.168.1.139:19333', 'add'))
    #print(rpc_connection.addnode('192.168.1.102:19333', 'remove'))
    #print(rpc_connection.addnode('192.168.1.102:19333', 'add'))
    ...
    #print(rpc_connection.gettransactionnew('db949bca827cbe1f5f18848cf55cbc2eedd3cf9633fb9b88e546171087cef4ff'))
    #print(rpc_connection.listunspent()[-1])
    ...
    #print(rpc_connection.sendtoaddress('mtUjv2TWT2wMQ86LoshoK5U8dPTL213Zep', 0.00001))
